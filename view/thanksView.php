...
<head>
    ...
    <title>TOTY - La beauté personnalisée - Merci !</title>

    <!-- stylesheet files -->
    <link href="../css/thanksViewSmartphoneStylesheet.css" rel="stylesheet" type="text/css" media="screen">
    <link href="../css/thanksViewTabletStylesheet.css" rel="stylesheet" type="text/css" media="screen and (min-width: 600px)">
    <link href="../css/thanksViewTabletLargeFormatStylesheet.css" rel="stylesheet" type="text/css" media="screen and (min-width: 800px)">
    <link href="../css/thanksViewComputerStylesheet.css" rel="stylesheet" type="text/css" media="screen and (min-width: 1025px)">
...
<div id="mainWrapper">
    ...
    <div id="mainContainer">
        ...
        <div id="mainContent">
            <p>
                Merci d'avoir répondu aux questions du formulaire.<br>
                A très bientôt sur toty.fr.
            </p>
        </div>
